...
public class HerenciaExtra_2 {

    public static void main(String[] args) {
        
        int cuentaPoli = 0, cuantaOfi = 0;
        ArrayList<Edificio> lista = new ArrayList<>();
        
        Polideportivo p1 = new Polideportivo("Cedrys", true, 80d, 20d, 170d);
        lista.add(p1);
        Polideportivo p2 = new Polideportivo("Polimenin", false, 76d, 18d, 140d);
        lista.add(p2);
        ...
        System.out.println("Cantidad de Edificios de Oficina " + cuantaOfi);
